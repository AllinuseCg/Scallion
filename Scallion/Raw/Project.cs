...
namespace Scallion.Raw
{
    internal class Project : MMDFile<Project>
    {
        ...
        public int RenderedAfterModelAccessoryIndex { get; set; }
        ...
        public override void Serialize(MoSerializer archive)
        {
            ...
            archive.Serialize(Audio);
            archive.Serialize(Video);
            archive.Serialize(BackgroundImage);
            ...
            archive.WriteInt32(RenderedAfterModelAccessoryIndex);
        ...
        public override void Deserialize(MoDeserializer archive)
        {
            ...
            RenderedAfterModelAccessoryIndex = archive.ReadInt32();
